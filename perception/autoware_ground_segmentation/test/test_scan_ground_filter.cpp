...
protected:
  void SetUp() override
  {
    ...
    parameters.emplace_back(rclcpp::Parameter("recheck_ignore_distance", recheck_ignore_distance_));
...
public:
  ...
  void parse_yaml()
  {
    ...
    recheck_ignore_distance_ = params["recheck_ignore_distance"].as<float>();
  ...
  float recheck_ignore_distance_;
